...
#define DEVLINK_CMD_ESWITCH_MODE_SET /* obsolete, never use this! */ \
	...
	DEVLINK_CMD_SUBDEV_RATE_NEW,
	DEVLINK_CMD_SUBDEV_RATE_DEL,
...
enum devlink_attr {
	...
	DEVLINK_ATTR_SUBDEV_RATE_GROUP_NAME,	/* string */
	DEVLINK_ATTR_SUBDEV_RATE_PARENT,	/* string */
